...
/*
     FILE ARCHIVED ON 8:55:53 Mar 22, 2016 AND RETRIEVED FROM THE
...
function prepare_summary()
{
  ...
  txt = txt + '<span style="font-size: 80%"><a href="http://ts.thanata.tk/planner/' + hash + '"http://ts.thanata.tk/planner/' + hash + '</a></span>';
  txt += '<div class="hr-div"></div>';
